...
#SBATCH --output=logs/sched_mds_layer_%A_%a.out
...
python ~/scratchcpriebe1/MO/network_manifolds/scripts/get_MDS_coordinates_mult_seeds.py --layer "$SLURM_ARRAY_TASK_ID"
